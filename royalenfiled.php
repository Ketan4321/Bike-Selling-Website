...
$brand = 'Royal Enfield';  // Set the brand to Honda
...
<body>
    ...
    <section id="bike-collection" class="collection-section">
        ...
        <div class="collection-container">
            <div class="bike-item">
                <a href="suzuki1.html">
                    <img src="img/royal1.jpg" alt="Bike 1">
            ...
            <div class="bike-item">
                <a href="#mountain-bikes">
                    <img src="img/royal2.jpg" alt="Bike 2">
            ...
            <div class="bike-item">
                <a href="#electric-bikes">
                    <img src="img/royal3.jpg" alt="Bike 3">
            ...
            <div class="bike-item">
                <a href="#hybrid-bikes">
                    <img src="img/royal4.jpg" alt="Bike 4">
            ...
            <div class="bike-item">
                <a href="#folding-bikes">
                    <img src="img/royal5.jpg" alt="Bike 5">
                    <h3>Royal Enfield Himalayan 411</h3>
                    <p>₹354,999/-</p>
                </a>
            </div>
            <div class="bike-item">
                <a href="#folding-bikes">
                    <img src="img/royal6.jpg" alt="Bike 5">
            ...
            <div class="bike-item">
                <a href="#folding-bikes">
                    <img src="img/royal7.jpg" alt="Bike 5">
