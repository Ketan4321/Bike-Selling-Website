...
// Get the bike_id from the URL query parameter
if (isset($_GET['bike_id'])) {
    ...
    // Redirect if no bike_id is provided
...
<head>
    ...
    <style>
        ...
        /* Left Side: Bike Image, Description, and Button */
        .bike-content {
            display: flex;
    ...
    <section class="bike-details">
        <div class="bike-info">
            <div class="bike-content">
                <h1><?php echo htmlspecialchars($bike['bikename']); ?></h1>
                <div class="bike-image-and-button">
                    <img src="<?php echo htmlspecialchars($bike['image']); ?>" alt="Bike Image">
                    <a href="booknow.html" class="buy-button">Book Now</a>
                </div>
                <div class="info">
                    <p><strong>Price:</strong> ₹<?php echo htmlspecialchars($bike['price']); ?></p>
                    <p><?php echo htmlspecialchars($bike['specifications']); ?></p>
                </div>
            </div>
